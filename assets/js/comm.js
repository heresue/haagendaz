...
// // Adjust video size on scroll
// window.addEventListener('scroll', () => {
//     const scrollPercentage = window.scrollY / (document.body.scrollHeight - window.innerHeight);
//     const newWidth = 560 + scrollPercentage * 400; // Adjust the width as needed
//     const newHeight = 315 + scrollPercentage * 225; // Adjust the height as needed
...
//   const videoWrap = document.querySelector(".ytb_wrap");

//   window.addEventListener("scroll", function () {
//     const scrollPercentage = window.scrollY / (ytbSection.offsetHeight - window.innerHeight);
//     const scale = 1 + scrollPercentage * 0.5; // 조절 가능한 확대 비율


//     // 동영상 크기 조절
//     videoWrap.style.transform = `scale(${scale})`;

//     // 동영상의 크기에 따라 섹션의 높이 재조정 (섹션의 높이에 따라 스크롤 높이 계산)
//     ytbSection.style.height = `${100 * scale}vh`;
//   });
// });
...
// const scrollPercentage = window.scrollY / (ytbSection.offsetHeight - window.innerHeight);
// const clipPathValue = 0 + scrollPercentage * 50; // 예시: 10에서 60 사이의 값으로 변경
